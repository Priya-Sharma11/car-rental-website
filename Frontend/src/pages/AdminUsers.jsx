            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {users.map((currUser, index) => (
                <tr key={index} className="">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap"><button>Edit</button></td>
                  <td className="px-6 py-4 whitespace-nowrap"><button onClick={()=> deleteUser(currUser._id)}>Delete</button></td>
                </tr>
              ))}
            </tbody>
          </table>
